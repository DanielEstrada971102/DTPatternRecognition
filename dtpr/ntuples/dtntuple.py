...
from dtpr.utils.shower_functions import build_fwshowers, build_real_showers, analyze_fwshowers
...
if __name__ == "__main__":
    ...
    input_folder = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../test/ntuples/DTDPGNtuple_12_4_2_Phase2Concentrator_Simulation_99.root"))
