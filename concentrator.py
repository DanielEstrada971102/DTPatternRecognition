...
histo_names = [
    ...
    'pyShower_st',
    'pyShower_sc',
    'seg_m_emushower_tprgm_MB1',
    'seg_m_emushower_tprgm_MB2',
    'seg_m_emushower_tprgm_MB3',
    'seg_m_emushower_tprgm_MB4',
    'seg_m_emushower_fprgm_MB1',
    'seg_m_emushower_fprgm_MB2',
    'seg_m_emushower_fprgm_MB3',
    'seg_m_emushower_fprgm_MB4',
    'seg_m_shower2comp_tprgm_MB1',
    'seg_m_shower2comp_tprgm_MB2',
    'seg_m_shower2comp_tprgm_MB3',
    'seg_m_shower2comp_tprgm_MB4',
    'seg_m_shower2comp_fprgm_MB1',
    'seg_m_shower2comp_fprgm_MB2',
    'seg_m_shower2comp_fprgm_MB3',
    'seg_m_shower2comp_fprgm_MB4',
    'seg_m_pyshower_tprgm_MB1',
    'seg_m_pyshower_tprgm_MB2',
    'seg_m_pyshower_tprgm_MB3',
    'seg_m_pyshower_tprgm_MB4',
    'seg_m_pyshower_fprgm_MB1',
    'seg_m_pyshower_fprgm_MB2',
    'seg_m_pyshower_fprgm_MB3',
    'seg_m_pyshower_fprgm_MB4',
    'eff_shower2comp_eq2Emu_MB1',
    'eff_shower2comp_eq2Emu_MB2',
    'eff_shower2comp_eq2Emu_MB3',
    'eff_shower2comp_eq2Emu_MB4',
    'eff_pyshower_eq2Emu_MB1',
    'eff_pyshower_eq2Emu_MB2',
    'eff_pyshower_eq2Emu_MB3',
    'eff_pyshower_eq2Emu_MB4',
    'digi_w_gmtns_MB1',
    'digi_w_gmtns_MB2',
    'digi_w_gmtns_MB3',
    'digi_w_gmtns_MB4',
